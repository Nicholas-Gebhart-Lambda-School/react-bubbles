...
- [ ] Explain what a token is used for.
  - A token is a randomized response that can be used to 'verify' whether a user is logged in.
- [ ] What steps can you take in your web apps to keep your data secure?
  - Privatized routes, secure endpoints that require authentication, not storing auth tokens in localStorage.
- [ ] Describe how web servers work.
  - A Web server is a program that uses HTTP to serve the files that form pages to users, in response to their requests, which are forwarded by their computers' HTTP clients
